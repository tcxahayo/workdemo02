...
const getUtils = (node, jsdoc, jsdocNode, settings, report, context) => {
...
const iterate = (ruleConfig, context, lines, jsdocNode, node, settings, sourceCode, iterator, state) => {
...
const iterateAllJsdocs = (iterator, ruleConfig) => {
  ...
  const callIterator = (context, node, jsdocNodes, state, lastCall) => {
    ...
    jsdocNodes.forEach(jsdocNode => {
      ...
      iterate(ruleConfig, context, lines, jsdocNode, node, settings, sourceCode, iterator, state);
    });
