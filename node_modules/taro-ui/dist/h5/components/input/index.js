...
export default class AtInput extends AtComponent {
  ...
  render() {
    const { className, customStyle, name, cursorSpacing, confirmType, cursor, selectionStart, selectionEnd, adjustPosition, border, title, error, clear, placeholder, placeholderStyle, placeholderClass, autoFocus, focus, value, required, onKeyboardHeightChange } = this.props;
    ...
    return <View className={rootCls} style={customStyle}>
        ...
        onFocus={this.onFocus} onBlur={this.onBlur} onConfirm={this.onConfirm} onKeyboardHeightChange={onKeyboardHeightChange} />
