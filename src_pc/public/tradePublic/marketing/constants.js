export const NO_AD_PID = 0;

/*
 * @Description 强中弱提示统一pid存储位置
*/
export const CONST_PIDS = {
    'item': {
        'Android': {
            'high': {
                'index': 1733,
 ...
 * @Description 运营埋点字段
*/
export const MARKET_BEACON_CONST = {
    show: 'show',
    click: 'click',
    second: 'second',
};
...
*/
export const MARKETING_STORAGE_KEY = 'marketingAdInfo';
...
*/
export const COMMON_MARKETING_MASK = [
    MARKETING_TYPE.modal,
    MARKETING_TYPE.afterAction,
    MARKETING_TYPE.midCoupon,
    MARKETING_TYPE.midModal,
    MARKETING_TYPE.modalVip,
];

/*
 * @Description PC页面通用mask广告预留位
*/
export const PC_COMMON_MARKETING_MASK = [
    MARKETING_TYPE.modal,
    MARKETING_TYPE.afterAction,
    MARKETING_TYPE.midCoupon,
    MARKETING_TYPE.modalVip,
 ...
 * @Description 兜底广告
*/
export const backupAd = {
    trade: {},
    item: {},
};

export const switchPid = {
    // 功能点
    '964': '3330',
    '963': '3328',
    '2814': '3351',
 ...
 * @Description 运营相关文案
*/
export const defaultMarketingContent = {
    vipName: {
        iOS: {
            0: '初级版',
            1: '高级版',
