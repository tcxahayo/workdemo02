...
import { DEFAULT_MEMO_PHRASE } from "tradePublic/customPhrases/consts";
import { getMemoCustomPhrases, memoPhraseSet } from "tradePublic/customPhrases";
import { showConfirmModal } from "mapp_common/utils";

class MemoPhrase extends Component {
    constructor (props) {
        super(props);
        this.state = {
            customPhrases: [],
    ...
    async componentWillMount () {
        let customPhrases = await getMemoCustomPhrases({ refresh:true });
        ...
        return (
            <View className='memo-or-rate-phrase-page'>
                ...
                <View className='custom-phrase'>
                    <View className='title'>自定义备注短语</View>
                    {
                        insertModal ?
                ...
                <View className='default-phrases'>
                    <View className='title'>默认备注短语</View>
                    <View className='phrases-spans'>
                        {
                            DEFAULT_MEMO_PHRASE.map(item =>
                                <View className='span'>
                                    <View className='span-item'>
                                        {item}
                                    </View>
