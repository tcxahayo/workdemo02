...
export const FULLINFO_SOURCE = {
    aiyong: 'aiyong',
    top: 'top',
};
export const SOLDGET_SOURCE = {
    aiyong: 'aiyong',
    top: 'top',
};
export const ADVANCEDSEARCH_SOURCE = {
    aiyong: 'aiyong',
    top: 'top',
    fullinfo: 'fullinfo',
};
...
export const pgApiHost = 'https://trade.aiyongbao.com';
